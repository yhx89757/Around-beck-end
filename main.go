...
const (
	...
	// need to update this url if you deploy it to cloud
	ES_URL      = "http://35.188.114.67:9200"
	BUCKET_NAME = "yhx89757-bucket"
)
...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	js, err := json.Marshal(posts) // convert to json object
	if err != nil {
